...
public class Image_UI_Manager : MonoBehaviour
{
    ...
    public GameObject loadingImagesScreen;
    ...
    {
        TelemetryLogger.Instance.LogUIInteraction("Single Image Fullscreen");
    ...
    public void SetMultiImageFullscreen()
    {
        if (interactedImage1 != null && interactedImage2 != null)
        {
            ...
            TelemetryLogger.Instance.LogUIInteraction("Double Image Fullscreen");
        }
    }
    ...
    {
        //loadingImagesScreen.SetActive(false);
    ...
    public void openImages()
    {
        ...
        //loadingImagesScreen.SetActive(false);
        Debug.Log($"[Loading] SetActive(false) at frame {Time.frameCount}");
        loadingImagesScreen.SetActive(false);
        ...
        TelemetryLogger.Instance.EndInteraction("HotspotOpen");
    }
    ...
    public void imageInteract(Image image, string year, InspectionImage imageData)
    {
        ...
        TelemetryLogger.Instance.LogUIInteraction("Click Imagem");
    }
